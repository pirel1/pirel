...
def Node(param_0, param_1):
    def Node_dlm___init__(label, parent):
...
def BinarySearchTree():
    def BinarySearchTree_dlm___init__():
        class_var.root = None
    def empty():
        class_var.root = None
    def is_empty():
    ...
    def inorder_traversal():
        nodes = class_var._inorder_traversal(class_var.root)
        return nodes
    ...
    def preorder_traversal():
        nodes = class_var._preorder_traversal(class_var.root)
        return nodes
    ...
    Clz = SkelClass('BinarySearchTree')
    class_var = Clz()
...
def test_remove():
    ...
    if t.root.right is None:
        raise Exception('Assertion failed')
    if t.root.right.right is None:
        raise Exception('Assertion failed')
    if t.root.right.right.right is not None:
        raise Exception('Assertion failed')
    if t.root.right.right.left is not None:
        raise Exception('Assertion failed')
    t.remove(7)
    if t.root.left is None:
        raise Exception('Assertion failed')
    if t.root.left.right is None:
        raise Exception('Assertion failed')
    if t.root.left.right.left is None:
        raise Exception('Assertion failed')
    if t.root.left.right.right is not None:
        raise Exception('Assertion failed')
    ...
    if t.root.left.left is None:
        raise Exception('Assertion failed')
    if t.root.left.right.right is None:
        raise Exception('Assertion failed')
    if t.root.left.left.label != 1:
        raise Exception('Assertion failed')
    ...
    if t.root.left.right.right.label != 5:
        raise Exception('Assertion failed')
    if t.root.left.right.left is not None:
        raise Exception('Assertion failed')
    if t.root.left.left.parent != t.root.left:
        raise Exception('Assertion failed')
    if t.root.left.right.parent != t.root.left:
    ...
    if t.root.left.label != 5:
        raise Exception('Assertion failed')
    if t.root.left.right is not None:
        raise Exception('Assertion failed')
    if t.root.left.left.label != 1:
        raise Exception('Assertion failed')
    if t.root.left.parent != t.root:
